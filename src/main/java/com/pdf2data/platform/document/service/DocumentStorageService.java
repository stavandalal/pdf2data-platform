...
public class DocumentStorageService {
    ...
    public void saveAll(Document doc, String rawJson, Map<String, Object> parsedFields) {
        ...
        try {
            ...
            relationalRepo.save(ExtractionResult.builder()
                    .rawJsonData(rawJson)
                    .document(savedDoc)
                    .build());
            mysqlSaved = true;
        } catch (Exception e) {
            System.err.println("Relational DB error: " + e.getMessage());
        }

        try {
            mongoRepo.save(MongoExtractionResult.builder()
            ...
            System.err.println("NoSQL DB error: " + e.getMessage());
        }
