...
public class AiExtractionService {
    ...
    /**
     * Generic text-generation entry point reused by classification, reasoning
     * and chat modules. Does not force JSON extraction semantics like
     * {@link #extractDataWithAI(String, String)} does.
     */
